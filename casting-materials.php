...
$getItemSculptureMaterials = $mysqli->query('SELECT i.item_code, i.item_description, icm.item_value, cm.description, cm.id 
FROM item_casting_material icm
JOIN item i
ON i.id = icm.item_id
JOIN casting_materials cm
ON cm.id = icm.sculpture_id') or die ($mysqli->error);
?>
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Casting Materials</h1>
            </div>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control" name="casting_material" required>
                                                <option value="">---</option>
                                                <?php while ($newCastingMaterials = $getCastingMaterials->fetch_assoc()){ ?>
                                                    <option value="<?php echo $newCastingMaterials['id'];?>"><?php echo $newCastingMaterials['description']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </td>
                                        <td>
                                ...
                                <button type="submit" class="btn btn-primary btn-sm mb-1 float-right" name="save_casting_materials"><i class="far fa-save"></i> Save</button>
                        </form>
                    </div>
                </div>
                <!-- Content Column -->
