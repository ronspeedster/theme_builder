                    ...
                    <table class="table" id="projetsDataTable">
                        ...
                        <?php while ($newProject=$getProjects->fetch_assoc()){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="production_plans.php?projectID=<?php echo $newProject['id']; ?>" class="btn btn-sm btn-primary" style="margin: 1px; display: none;"><i class="far fa-clock"></i> View Production Plan</a>
